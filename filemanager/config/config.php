...
$upload_dir = '/'.$_SESSION['user_name'].'/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../'.$_SESSION['user_name'].'/'; // relative path from filemanager folder to upload folder (with final /)
...
$access_keys = array(md5($_SESSION['user_name']),'someoneElseKey');
...
$ext_file = array('doc', 'docx','rtf', 'pdf', 'xls', 'xlsx', 'txt', 'csv','html','xhtml','psd','sql','log','fla','xml','ade','adp','mdb','accdb','ppt','pptx','odt','ots','ott','odb','odg','otp','otg','odf','ods','odp','css','ai','c'); //Files
...
*******************/
$aviary_active 	= TRUE;
$aviary_key 	= "35d2e877f765093e";
$aviary_secret	= "87ebb56c9bfdb7a2";
$aviary_version	= 3;
$aviary_language= 'en';
...
$hidden_folders = array('.gnome2','.mozilla','.ssh');
// set the names of any files you want hidden. Remember these names will be hidden in all folders (eg "this_document.pdf", "that_image.jpg" )
$hidden_files = array('config.php','file.gnome2','file.mozilla','file.ssh');
