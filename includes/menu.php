    ...
    <script>
        $(function() {
            $('html').contextPopup({
                title: 'Options',
                items: [
                    {label: 'Refresh', icon: 'icons/refresh.png', action: function() {
                            location.reload()
                        }},
                    null, // divider
                    {label: 'About', icon: 'icons/about.png', action: function() {
                            alert('WebOs is a web based desktop environment system designed by\n Parth Shah\n Chirag Vidja\n Janvi Patel')
                        }},
                    null, // divider
                    {label: 'Copyright 2014 WebOs', icon: 'icons/copy.png', action: function() {
                            alert('See github.com/shahparth123 for more information')
                        }}
                ]
            });
        });
...
//echo $q;
    ...
    while ($row1 = mysql_fetch_array($r1)) {
        ?>
        <div class="desktopicon">
            <a href="<?php echo $row1['url']; ?>" id="<?php echo $row1['css_id']; ?>" <?php if ($row1['new'] == 1) {
            echo "target=_blank";
        } ?> >
