								...
								<form role="form" method="POST" action="">
								   <div class="box-body">
                                       ...
                                       <table id="removeicon" class="table table-bordered table-hover">
										...
										if($row['active']==1){echo "Enabled";}else{echo "Disabled";}
										echo "</td><td><a class=\"btn btn-danger btn-sm\" href=\"disable.php?id=".$row['user_id']."\">";
										if($row['active']==1){echo "Disable";}else{echo "Enable";}
										echo "</a></td></tr>";
										}
										?>
										</tbody>
