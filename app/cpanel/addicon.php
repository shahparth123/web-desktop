...
if (empty($_POST) === false) {
    if (isset($_POST['name']) == true && $_POST['name'] != "") {
        $image = san($_POST['image']);
        $id = san($_POST['id']);
        $js = san($_POST['javascript']);
        $url = san($_POST['url']);
        $name = san($_POST['name']);
        $q = "INSERT INTO `icons` (`id`, `user_id`, `name`, `image`, `css_id`, `javascript`, `url`) VALUES (NULL, '" . $session_user_id . "', '$name', '$image', '$id', '$js', '$url')";
                                ...
                                <form role="form" method="POST" action="">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="name" name="name" placeholder="Icon Name" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="image">Icon Image*</label>
                                            <input type="text" class="form-control" id="image"  name="image" placeholder="Image URL for icon"required>
                                        </div>
                                        <div class="form-group">
                                            <label for="cssid">CSS ID:</label>
                                            <input type="text" class="form-control" id="cssid" placeholder="ID for applying CSS" name="cssid">
                                        </div>
                                        <div class="form-group">
                                            <label for="url">URL:</label>
                                            <input type="text" class="form-control" id="url" placeholder="URL of page to be launched" name="url">
                                        </div>
                                        <div class="form-group">
                                            <label for="javascript">Java Script:</label>
                                            <input type="text" class="form-control" id="javascript" placeholder="Add custom javascript here" name="javascript">
                                        </div>
